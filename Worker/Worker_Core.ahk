...
; Version: 1.0.1
; Last change: Added new globals for script toggles section and updated map.
; Content-Fingerprint: 2026-01-29T20-13-10Z-XC85IUG6
; ------------------------------------------------------------------
...
LoadWorkerConfiguration() {
    ...
    global g_AntiBanEnabled, g_FastDropEnabled, g_AutoHealEnabled, g_RandomClickEnabled
    ...
    g_ShowOverlay                 := LoadSetting("UI", "ShowOverlay",            defaults["UI|ShowOverlay"])
    g_AntiBanEnabled              := LoadSetting("Script", "AntiBan",            defaults["Script|AntiBan"])
    g_FastDropEnabled             := LoadSetting("Script", "FastDrop",           defaults["Script|FastDrop"])
    g_AutoHealEnabled             := LoadSetting("Script", "AutoHeal",           defaults["Script|AutoHeal"])
    g_RandomClickEnabled          := LoadSetting("Script", "RandomClick",        defaults["Script|RandomClick"])
