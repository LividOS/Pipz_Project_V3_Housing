...
; Content-Fingerprint: 2026-01-28T23-10-18Z-LMVLEBA2
; ------------------------------------------------------------------
...
;   - All GUI events should route into Controller_Core logic (no deep logic here).
...
global g_RandomClickEnable   := LoadSetting("Script", "RandomClick",          DEFAULTS["Script|RandomClick"])
